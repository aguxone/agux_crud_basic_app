...
INSTALLED_APPS = [
    ...
    # We add the ads app Django3w5
    'ads.apps.AdsConfig',

    # We don't need these for Django3w5
...
DATABASES = {
             'default': {
                        ...
                        'NAME': 'aguxcourse$default', # Name of the database, here default, after specifying user
                        'USER': 'aguxcourse', # NAME of PythonAnywhere account
                        'PASSWORD': 'aguxpass', # Pass of MySQL database!
                        'HOST': 'aguxcourse.mysql.pythonanywhere-services.com', #Host has pythonanywhere user
                         'OPTIONS': {
